...
class SpecialWorkerCard extends StatelessWidget {
  final WorkerModel worker;
  final VoidCallback onFavoritePressed;

  const SpecialWorkerCard({
    Key? key,
...
class SpecialWorkersList extends StatefulWidget {
  final List<WorkerModel> workers;

  const SpecialWorkersList({Key? key, required this.workers}) : super(key: key);

  @override
  State<SpecialWorkersList> createState() => _SpecialWorkersListState();
}

class _SpecialWorkersListState extends State<SpecialWorkersList> {
  @override
  Widget build(BuildContext context) {
